...
class Prime_Slider_Loader {
	...
	public function register_site_styles() {
		...
		wp_register_style( 'bdt-prime-slider-general', BDTPS_ASSETS_URL . 'css/general' . $direction_suffix . '.css', [], BDTPS_VER );
		wp_register_style( 'bdt-prime-slider-isolate', BDTPS_ASSETS_URL . 'css/isolate' . $direction_suffix . '.css', [], BDTPS_VER );
		wp_register_style( 'bdt-prime-slider-blog', BDTPS_ASSETS_URL . 'css/blog' . $direction_suffix . '.css', [], BDTPS_VER );
		wp_register_style( 'bdt-prime-slider-woocommerce', BDTPS_ASSETS_URL . 'css/woocommerce' . $direction_suffix . '.css', [], BDTPS_VER );
		wp_register_style( 'bdt-prime-slider-custom', BDTPS_ASSETS_URL . 'css/custom' . $direction_suffix . '.css', [], BDTPS_VER );
		wp_register_style( 'bdt-prime-slider-flogia', BDTPS_ASSETS_URL . 'css/flogia' . $direction_suffix . '.css', [], BDTPS_VER );
		wp_register_style( 'bdt-prime-slider-woostand', BDTPS_ASSETS_URL . 'css/woostand' . $direction_suffix . '.css', [], BDTPS_VER );
		wp_register_style( 'bdt-prime-slider-skin-slide', BDTPS_ASSETS_URL . 'css/slide' . $direction_suffix . '.css', [], BDTPS_VER );
		wp_register_style( 'bdt-prime-slider-skin-crelly', BDTPS_ASSETS_URL . 'css/crelly' . $direction_suffix . '.css', [], BDTPS_VER );
		wp_register_style( 'bdt-prime-slider-skin-meteor', BDTPS_ASSETS_URL . 'css/meteor' . $direction_suffix . '.css', [], BDTPS_VER );
		wp_register_style( 'bdt-prime-slider-skin-coral', BDTPS_ASSETS_URL . 'css/coral' . $direction_suffix . '.css', [], BDTPS_VER );
		wp_register_style( 'bdt-prime-slider-skin-slice', BDTPS_ASSETS_URL . 'css/slice' . $direction_suffix . '.css', [], BDTPS_VER );
		wp_register_style( 'bdt-prime-slider-skin-locate', BDTPS_ASSETS_URL . 'css/locate' . $direction_suffix . '.css', [], BDTPS_VER );
		wp_register_style( 'bdt-prime-slider-skin-zinest', BDTPS_ASSETS_URL . 'css/zinest' . $direction_suffix . '.css', [], BDTPS_VER );
		wp_register_style( 'bdt-prime-slider-skin-folio', BDTPS_ASSETS_URL . 'css/folio' . $direction_suffix . '.css', [], BDTPS_VER );
