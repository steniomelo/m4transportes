...
class Admin {
	...
	public function enqueue_styles() {
        ...
        // javascript enqueue
		wp_enqueue_script( 'bdt-uikit', BDTPS_ASSETS_URL . 'js/bdt-uikit' . $suffix . '.js', ['jquery'], BDTPS_VER );
	...
	public function plugin_action_meta( $links ) {
		...
		//$links = array_merge( $links, [ sprintf( '<a href="%s">%s</a>', prime_slider_dashboard_link('#license'), esc_html__( 'License', 'bdthemes-prime-slider' )
		//) ] );
