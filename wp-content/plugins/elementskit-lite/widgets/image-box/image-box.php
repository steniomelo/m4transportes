...
class Elementskit_Widget_Image_Box extends Widget_Base {
    ...
    protected function render_raw( ) {
        ...
        if($settings['ekit_image_box_enable_link'] == 'yes' && isset($settings['ekit_image_box_website_link']['url'])){
            $img_nofollow = ( $settings['ekit_image_box_website_link']['nofollow'] == 'on') ? 'nofollow' : '';

            $image_html = "<a href='".esc_url($settings['ekit_image_box_website_link']['url'])."' rel='". $img_nofollow ."' target='".(($settings['ekit_image_box_website_link']['is_external'] == 'on') ? '_blank' : '')."'>".$image_html."</a>";
        }
